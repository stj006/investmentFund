...
3. 权限：
   - **Repository access**：Only select → `stj001/investmentFund`
...
| URL | `https://api.github.com/repos/stj001/investmentFund/actions/workflows/daily_report.yml/dispatches` |
| Schedule | 每天 **20:35** |
...
| URL | `https://api.github.com/repos/stj001/investmentFund/actions/workflows/weekly_recommend.yml/dispatches` |
| Schedule | 每周日 **10:00** |
| Timezone | **Asia/Shanghai** |
...
2. GitHub → [Actions](https://github.com/stj001/investmentFund/actions) → 出现新的 **workflow_dispatch** 运行且绿色 ✓  
3. 邮箱收到 `【持仓】` 或 `【选基】` 邮件  
...
*仓库：stj001/investmentFund · 日报 20:35 · 选基 周日 10:00（北京时间）*
