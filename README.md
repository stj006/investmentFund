...
- **在线地址**：https://stj006.github.io/investmentFund/dashboard/
...
- 管理仓 **60% 宽基**（110020 沪深300 + 022430 中证A500，新增资金 50:50）+ **40% 行业**（方案 B：主卫星 25% 创新药 + 次席 15% 黄金 004253）
- **002900 500信息** 为成长增强，占管理仓上限 10%
- **270042 / 004253** 等定投旁路不计入 60/40
...
`config/strategy.yaml`：管理仓 60/40（宽基/行业）；定投旁路不计再平衡；市值 < 5000 元小账户模式。
